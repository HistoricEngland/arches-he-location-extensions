...
module.exports = {
  input: {
    path: "./arches_he_location_extensions/src", // only files in this directory are considered for extraction
  ...
  output: {
    path: "./arches_he_location_extensions/locale", // output path of all created files
