# Contributing to arches-he-location-extensions

arches-he-location-extensions is an [Arches](https://www.archesproject.org/) application developed and maintained by [Historic England](https://historicengland.org.uk/) primarily for our own internal systems. The codebase is published openly in the spirit of transparency and in case it is useful to others in the Arches community.
