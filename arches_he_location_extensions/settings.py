"""
Django settings for arches_he_location_extensions project.
"""
...
APP_NAME = "arches_he_location_extensions"
...
DATATYPE_LOCATIONS.append("arches_he_location_extensions.datatypes")
FUNCTION_LOCATIONS.append("arches_he_location_extensions.functions")
ETL_MODULE_LOCATIONS.append("arches_he_location_extensions.etl_modules")
SEARCH_COMPONENT_LOCATIONS.append("arches_he_location_extensions.search_components")
...
SECRET_KEY = "django-insecure-wqvd_8gk)a$m(b#$lug1te&p!z*6e^^^h#cqx8hh3dr&#gc*sg"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "arches_he_location_extensions.urls"
ROOT_HOSTCONF = "arches_he_location_extensions.hosts"

DEFAULT_HOST = "arches_he_location_extensions"
...
ELASTICSEARCH_PREFIX = "arches_he_location_extensions"

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'arches_he_location_extensions.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    # "silk",
    "arches_he_location_extensions",  # Ensure the project is listed before any other arches applications
)
...
WSGI_APPLICATION = "arches_he_location_extensions.wsgi.application"
...
SESSION_COOKIE_NAME = "arches_he_location_extensions"
...
# ES_MAPPING_MODIFIER_CLASSES = ["arches_he_location_extensions.search.es_mapping_modifier.EsMappingModifier"]
